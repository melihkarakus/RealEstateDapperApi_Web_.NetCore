...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        [HttpGet("AveregeProductPriceByRent")]
        public IActionResult AveregeProductPriceByRent()
        {
            return Ok(_statisticsRepository.AveregeProductPriceByRent());
        }
        [HttpGet("AveregeProductPriceBySale")]
        public IActionResult AveregeProductPriceBySale()
        {
            return Ok(_statisticsRepository.AveregeProductPriceBySale());
        }
